...
const Contact = () => (
  <section id="contact" className="snap-center flex-shrink-0 w-screen min-h-screen flex flex-col md:flex-row items-center justify-center bg-[#10101a] text-light relative overflow-hidden space-y-12 md:space-y-0 md:space-x-12 py-12">
    ...
    <form className="flex flex-col items-center space-y-4 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-10 shadow-2xl w-full max-w-md z-10 relative animate-fade-in">
      <input className="bg-black/60 text-light px-4 py-2 rounded w-full border border-techblue/30 focus:border-techblue outline-none transition" placeholder="Your Email" />
      <textarea className="bg-black/60 text-light px-4 py-2 rounded w-full border border-techblue/30 focus:border-techblue outline-none transition" placeholder="Message" rows={4} />
      <button type="submit" className="relative bg-techblue text-white px-8 py-2 rounded-full font-bold font-rajdhani text-lg shadow-lg overflow-hidden transition-all duration-300 hover:bg-neongreen focus:outline-none group">
        <span className="relative z-10">Send</span>
        {/* Glowing animated border */}
        <span className="absolute inset-0 rounded-full border-2 border-techblue opacity-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 pointer-events-none animate-pulse" />
      </button>
    </form>
